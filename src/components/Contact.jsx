            ...
            <div className="bg-white p-8 rounded-2xl shadow-xl">
              ...
              <div className="space-y-6">
                ...
                <button
                  ...
                  className="w-full bg-gradient-to-r from-orange-500 to-red-500 text-white py-4 px-6 rounded-lg hover:from-orange-600 hover:to-red-600 transition-all duration-300 font-semibold text-lg shadow-lg hover:shadow-xl"
                >
                  Send Message 📨
                </button>
